...
class DashboardController extends Controller
{
    public function __invoke()
    {
        ...
        $stats = [
            ...
            'activeMembers' => DB::table('tb_user_peminjam')->where('status_aktif', true)->count(),
        ...
        $recentLoans = DB::table('tb_pinjaman')
            ...
            ->select('tb_data_buku.judul as title', 'tb_user_peminjam.nama as borrower', 'tb_pinjaman.tanggal_pinjam as loan_date', 'tb_pinjaman.status')
